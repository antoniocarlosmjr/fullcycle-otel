...
import (
	...
	"github.com/fullcycle-otel/service-b/config"
	"github.com/fullcycle-otel/service-b/infra"
	"github.com/fullcycle-otel/service-b/model"
	"github.com/fullcycle-otel/service-b/utils"
...
func fetchViaCEP(ctx context.Context, cep model.CEP) (*model.ResponseViaCEP, error) {
...
func fetchWeather(ctx context.Context, city string) (*model.ResponseWeather, error) {
	...
	var response model.ResponseWeather
	if err = json.NewDecoder(res.Body).Decode(&response); err != nil {
		return nil, err
	}
